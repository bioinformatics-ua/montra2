...
class GroupEditorsTestCase(MontraTestCase):

    def test_group_editors(self):

        self.verify_user1_can_not_access()

        self.add_user1_to_editors_group()
    ...
    def add_user1_to_editors_group(self):
    ...
    def verify_user1_can_access(self):
        ...
        databases_menu_button.find_element(By.XPATH, '../../ul//a[text()[contains(., "New Entry")]]').click()

        assert 'EHDEN Questionnaire Database' in self.driver.page_source
