...
function collapse_expand(context){
          ...
          {
            $(context).html('<i class="fas fa-fw fa-plus"></i>&nbsp; Expand all');
          ...
          {
              $(context).html('<i class="fas fa-fw fa-minus"></i>&nbsp; Collapse all');
...
function doublecheck_expansions(){
          ...
          if ($(context).text().indexOf('Collapse')!=-1)
          {
              $("#compare_container .collapse").collapse("show");
          }
          else
          {
              $("#compare_container .collapse").collapse("hide");
          }
}
...
(function ($) {
    window.cp_cache={};
    $("#compare_container .collapse").collapse({toggle: false});
...
DatabaseSelector.prototype = {
  ...
  __inverseintersectDropdown: function(not_fingerprint_id, reference){
    ...
    var dropdown=[];
    if(reference){
      dropdown.push('<div class="btn-group"><a style="font-size: 12px; font-weight: normal;" class="btn btn-sm btn-success dropdown-toggle" data-toggle="dropdown" href="#">');
      dropdown.push('Reference');
    } else{
      dropdown.push('<div class="btn-group"><a style="font-size: 12px; font-weight: normal;" class="btn btn-sm btn-primary dropdown-toggle" data-toggle="dropdown" href="#">');
