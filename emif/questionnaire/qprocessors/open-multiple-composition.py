...
@question_proc('open-multiple-composition')
def question_open_multiple_composition(request, question):
    ...
    return {
        ...
        'value' : value,
        "hasValue": value!= "",
        'template' : 'questionnaire/open-multiple-composition.html',
    }


@answer_proc('open-multiple-composition')
def process_open_multiple_composition(question, ansdict):
...
add_type('open-multiple-composition', 'Composed variables, multiple answers, open value')
