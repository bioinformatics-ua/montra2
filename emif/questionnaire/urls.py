...
urlpatterns = [
    ...
    url(r'^geonames$', GeonamesView.as_view()),

    url(r'^preview-loading/(?P<questionnaire_id>[0-9]+)$',
        QuestionnairePreviewLoadingView.as_view(),
        name='questionnaire-preview-loading'),
]
