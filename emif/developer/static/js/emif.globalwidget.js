    ...
    $.fn.globalwidget = function(options) {
        ...
        var control = {
            addLayout: function(name, head, body){
                ...
                console.log(name);
                self.html(
                    '<div class="panel panel-default" id="'+name+'" style="border: 1px solid #e5e5e5;"><div>\
...
var GlobalWidget = function GlobalWidget(widgetname, header, icon) {
    ...
    __init  :   function(control, parent){
        ...
        var body = '<div class="panel-collapse"><div class="panel-body global-body">'+this.content+'</div></div>';
