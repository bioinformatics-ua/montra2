...
function shareByEmail(url, community){

    var this_share = bootbox.dialog({message:
                    ...
                    '<input type="text" data-role="tagsinput" class="emailsinput form-control" placeholder="Add Emails">'+
