        ...
        var private_funcs = {
            ...
            __clampHeight: function(context) {
                $('[data-clampedheight]', context).each(function() {
                    ...
                    if (parentPanel) {
                        var sideBarNavWidth = $(parentPanel).height() - 10 - parseInt(elem.css('paddingTop')) - parseInt(elem.css('paddingBottom')) - parseInt(elem.css('marginTop')) - parseInt(elem.css('marginBottom')) - parseInt(elem.css('borderTopWidth')) - parseInt(elem.css('borderBottomWidth'));
            ...
            __renderRegistry: function(){
                if(settings.showRegistry != null && settings.registryTarget != null){
                    ...
                    var to_render = '<a class="btn btn-default dropdown-toggle" data-toggle="dropdown" href="#" id="add_list_toolbar"><i class="icon-retweet"></i> Add Widgets <span class="caret"></span></a>'+
...
var DashboardWidget = function DashboardWidget(widgetname, header, width, height, pos_x, pos_y, icon) {
    ...
    __init  :   function(gridster, parent){
        ...
        var __widgetentry = '<li class="panel panel-default" id="'+ this.widgetname+'"><div style="'+this.header_style+'" class="panel-heading widget-header"><div title="Drag to change widget position" class="dragtooltip pull-left">';
        ...
        '<div class="pull-right removewidget"><i class="icon-remove"></i></div></div><div class="panel-collapse"><div style="overflow-y:auto; height: auto;" data-clampedheight="#'+
        this.widgetname+'" class="panel-body">'+this.content+'</div></div></li>';
    ...
    __refresh : function(){
        ...
        $('#'+this.widgetname+' .panel-body').html(this.content);
    },
