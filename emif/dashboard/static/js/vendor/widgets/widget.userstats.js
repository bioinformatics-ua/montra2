    ...
    __init : function(gridster, parent){
        ...
        .done(function(data) {
            ...
            if(data.stats){
                ...
                if(mostpop.name != '---'){
                    self.content += '<strong>Most popular database:</strong> <a href="c/'+document.getElementById("communityindicator").value+'/fingerprint/'+mostpop.hash+'/1/">'+
