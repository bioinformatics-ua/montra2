...
var CommonActionsWidget = function CommonActionsWidget(widgetname, width, height, pos_x, pos_y){
    ...
    __init : function(gridster, parent){
        ...
        self.icon = '<i class="fas fa-fw fa-cogs"></i>';
        ...
        .done(function(data) {
            ...
            self.content=   '<div style="min-width: 180px; vertical-align: top; display: inline-block;"><span class="lead"><i class="fas fa-fw fa-eye"></i> View</span><br />'+
            ...
            self.content += '</div><div style="min-width: 200px; vertical-align: top; display: inline-block;"><span class="lead"><i class="fas fa-fw fa-plus-circle"></i> Add New </span><br />';
            ...
            self.content+=  '</div><div style="min-width: 200px; vertical-align: top; display: inline-block;"><span class="lead"><i class="fas fa-fw fa-search"></i> Search </span><br />';
