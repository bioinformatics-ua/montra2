...
$(function(){
    dashzone = $("#playground").dashboard(
        {
            ...
            initial: function () {
                ...
                //dashzone.addWidget("recommendations");
                dashzone.addWidget("subscribed");
            }
        });
    ...
    dashzone.register(new TagCloudWidget("tagcloud",  4, 1, 6, 6));
    dashzone.register(new SubscribedWidget("subscribed",  2, 1, 6, 6));
